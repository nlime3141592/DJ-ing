...
namespace nl
{
    ...
    /// </summary>
    public class ChannelOut : IWavePlayer, IWavePosition
    {
        ...
        public void Init(IWaveProvider waveProvider)
        {
            ...
            MmResult masterResult;
            MmResult monitorResult;

            lock (waveOutLock)
            {
                masterResult = WaveInterop.waveOutOpenWindow(out hWaveOut, (IntPtr)MasterDeviceNumber, waveStream.WaveFormat, callbackEvent.SafeWaitHandle.DangerousGetHandle(), IntPtr.Zero, WaveInterop.WaveInOutOpenFlags.CallbackEvent);
                monitorResult = WaveInterop.waveOutOpenWindow(out hWaveOut, (IntPtr)MonitorDeviceNumber, waveStream.WaveFormat, callbackEvent.SafeWaitHandle.DangerousGetHandle(), IntPtr.Zero, WaveInterop.WaveInOutOpenFlags.CallbackEvent);
            }

            MmException.Try(masterResult, "waveOutOpen");
            MmException.Try(monitorResult, "waveOutOpen");
